  ...
  return (
    <div className="border-t border-gray-200 bg-white p-3">
      {showPresets && presets.length > 0 && (
        <div
          ref={presetRef}
          className="mb-2 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden"
        >
      ...
      <div className="flex items-end gap-2">
        <div className="flex-1 relative">
          <textarea
            ...
            maxLength={maxChars}
            rows={1}
            className="w-full resize-none rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 transition-shadow"
          />
          <div className="absolute bottom-2 right-2 flex items-center gap-1">
            <button
              onClick={() => setShowPresets(!showPresets)}
              className={`p-1 rounded transition-colors ${
                showPresets ? "bg-blue-100 text-blue-600" : "text-gray-400 hover:text-gray-600"
              }`}
